...
const DOM = {
    tiles: getTilesDOM(),
    // x: "Luke Skycrawler", // Image here
    // o: "Darth Vader", // Image here
...
function colorDiv(color) {
    return `<span style="background-color: ${color}; height: 14px; width: 14px; display: inline-block;"></span>`;
}
...
let state = {
    ...
    playerName: {
        ...
        o: colorDiv("red") // colorDiv(this.color.o),
    },
    point: {
        x: 0,
        o: 0
...
function declareDraw() {
    // Display UI
    DOM.alert.innerHTML = `<p>Look like no body win</p><p>It's a tie!</p>`;
...
function declareWinner() {
    // Display UI
    DOM.alert.innerHTML = `<p>Player ${state.playerName[state.currentPlayer]
        } has won</p>`;
...
// Change AVATAR Color Raw Code  // NOT WORKING at the moment  // Found Library
